...
import dev.helikon.client.module.combat.ArrowDmg;
...
import dev.helikon.client.module.movement.Dolphin;
...
import dev.helikon.client.module.movement.Jesus;
...
public final class HelikonClient implements ClientModInitializer {
    ...
    public void onInitializeClient() {
        ...
        NoShieldOverlay noShieldOverlay = new NoShieldOverlay();
        ...
        modules.register(noShieldOverlay);
        ...
        events.subscribe(ClientTickEvent.class, event -> {
            if (event.phase() == ClientTickEvent.Phase.POST) {
                ...
                modules.runGuarded(reach, "tick", () -> {
                    if (!combatAttackStarted.get()) {
                        combatAttackStarted.set(MinecraftCombatAccess.tickReach(clientTick, reach,
                                combatSnapshot.get(), combatTracker));
                    }
                });
